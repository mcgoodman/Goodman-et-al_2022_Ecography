...
### overlap functions to accompany Carroll et al. (2019) 'A review of methods 
### for quantifying predator-prey overlap,' Global Ecology and Biogeography 
### Please see accompanying paper for detailed descriptions of metrics and 
