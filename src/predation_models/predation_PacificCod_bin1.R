...
##' @details Predator considered: Pacific Cod bin 1
...
proj_dir <- here()
output_dir <- paste0(here("model output", "PESC", "Pacific_Cod_bin1"), "/")
...
DF = read.csv( paste0( data_dir, "Data_PacificCod_bin1_VAST.csv" ) )
