...
##' @details Predator considered: Pacific Halibut bin 1
...
proj_dir <- here()
output_dir <- paste0(here("model output", "PESC", "Pacific_Halibut_bin1"), "/")
...
DF = read.csv( paste0( data_dir, "Data_PacificHalibut_bin1_VAST.csv" ) )
