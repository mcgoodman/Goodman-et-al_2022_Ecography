...
##' @details Predator considered: Walleye Pollock bin 2
...
proj_dir <- here()
output_dir <- paste0(here("model output", "PESC", "Walleye_Pollock_bin2"), "/")
...
DF = read.csv( paste0( data_dir, "Data_WalleyePollock_bin2_VAST.csv" ) )
