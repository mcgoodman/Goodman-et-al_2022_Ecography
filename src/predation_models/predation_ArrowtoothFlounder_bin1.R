...
##' @details Predator considered: Arrowtooth Flounder bin 1
...
proj_dir <- here()
output_dir <- paste0(here("model output", "PESC", "Arrowtooth_Flounder_bin1"), "/")
...
DF = read.csv( paste0( data_dir, "Data_ArrowtoothFlounder_bin1_VAST.csv" ) )
