...
##' @details Predator considered: Pacific Halibut bin 2
...
proj_dir <- here()
output_dir <- paste0(here("model output", "PESC", "Pacific_Halibut_bin2"), "/")
...
DF = read.csv( paste0( data_dir, "Data_PacificHalibut_bin2_VAST.csv" ) )
