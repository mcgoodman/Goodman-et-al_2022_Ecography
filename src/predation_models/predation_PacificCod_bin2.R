...
##' @details Predator considered: Pacific Cod bin 2
...
proj_dir <- here()
output_dir <- paste0(here("model output", "PESC", "Pacific_Cod_bin2"), "/")
...
DF = read.csv( paste0( data_dir, "Data_PacificCod_bin2_VAST.csv" ) )
